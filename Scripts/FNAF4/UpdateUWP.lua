...
if Conditions["UsingUWP"] then
    path = ParsePath("[LOCALAPPDATA]\\Packages\\ClickteamLLC.31104016D2509_6hr7gq7xhprb4\\SystemAppData\\wgs\\000901FE5FE01A72_0000000000000000000000006AB48DB9")
    ...
    EditorData.Config.FilePath = ParsePath("[MMF]\\fn4")
