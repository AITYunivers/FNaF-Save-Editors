...
if Conditions["UsingUWP"] then
    path = ParsePath("[LOCALAPPDATA]\\Packages\\ClickteamLLC.FiveNightsatFreddys3_6hr7gq7xhprb4\\SystemAppData\\wgs\\000901FE5FE01A72_000000000000000000000000602F0862")
    ...
    EditorData.Config.FilePath = ParsePath("[MMF]\\freddy3")
