...
if Conditions["UsingUWP"] then
    path = ParsePath("[LOCALAPPDATA]\\Packages\\ClickteamLLC.362225AF1F241_6hr7gq7xhprb4\\SystemAppData\\wgs\\000901FE5FE01A72_000000000000000000000000616FDC96")
    ...
    EditorData.Config.FilePath = ParsePath("[MMF]\\CN")
