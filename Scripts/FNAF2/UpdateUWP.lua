...
if Conditions["UsingUWP"] then
    path = ParsePath("[LOCALAPPDATA]\\Packages\\ClickteamLLC.24355532CC497_6hr7gq7xhprb4\\SystemAppData\\wgs\\000901FE5FE01A72_000000000000000000000000663E34F9")
    ...
    EditorData.Config.FilePath = ParsePath("[MMF]\\freddy2")
